...
<div >
    <div id="app" style="margin-top: 80px;">
        <nav class="navbar navbar-default navbar-fixed-top" style="background-color:rgba(72, 76, 74, 0.9); padding: 10px">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse" >
                    ...
                    <ul class="nav navbar-nav navbar-right" style="background-color:transparent;font-size: 17px">
